...
class Config:
    ...
    OPENAI_ASSISTANT_TEMPLATE_MAKER = os.getenv("OPENAI_ASSISTANT_TEMPLATE_MAKER")  
    OPENAI_ASSISTANT_REVERSED_DYNAMIC_STRUCTURER = os.getenv("OPENAI_ASSISTANT_REVERSED_DYNAMIC_STRUCTURER")
